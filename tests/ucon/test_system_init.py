...
from ucon.system import active, active_system
...
class TestActiveSystemGraph:
    ...
    def test_graph_has_units(self):
        graph = active_system().conversion_graph
...
class TestActiveSystemConstants:
    ...
    def test_returns_dict(self):
        constants = active_system().constants
...
class TestObjectIdentity:
    ...
    def test_units_are_same_objects(self):
        """active_system().units['meter'] is active_system().conversion_graph._name_registry_cs['meter']"""
        system = active_system()
